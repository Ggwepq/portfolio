...
// The exact pixelated / kaomoji face with eyes that track mouse cursor
function AnimatedPixelFace({ pupilOffset = { x: 0, y: 0 }, isHovered = false, mood = 'idle', size = 'normal' }) {
  ...
  return (
    <div className={`pixel-face-wrapper ${size} ${mood} ${isHovered ? 'hovered' : ''}`}>
      {isCold ? (
        ...
        >
          ...
          {isTriggerHovered && (
            <div className="companion-hover-dialogue" onClick={handleOpen}>
              <span className="dialogue-sparkle">🌸</span>
              <span className="dialogue-text">{PROMPT_HINTS[hintIndex]}</span>
          ...
          <button
            type="button"
            className="companion-trigger-pill"
            onClick={handleOpen}
            aria-label="Open Cedjuani Companion"
          >
            <AnimatedPixelFace
            ...
            <div className="trigger-label-group">
              <span className="trigger-name">Cedjuani</span>
            ...
            <div className="header-identity">
              ...
              <div className="identity-text">
                ...
                <div className="status-badge">
                  <span className={`pulse-dot ${mood}`} />
                  <span className="status-label">
                    {mood === 'thinking' ? 'Thinking...' : mood === 'cold' ? 'Restricted Mode' : 'Online • Ready to help'}
                  </span>
                </div>
              </div>
            </div>
